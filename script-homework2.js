...
const users = {
  ...
  "Ekenem Dunkwu": { password: "Eke@57", role: "student", class: "JSS2" },
  ...
  "Mr. Anonye": { password: "Ab@12", role: "teacher", subjects: ["Computer", "CRS", "DigitalTech"] },
...
function fillStudentSubjectOptionsForUser(user) {
  ...
  const juniorSubs = ["DigitalTech", "Computer", "CRS", "Agric", "HomeEconomics", "BusinessStudies",
    "SocialStudies", "BasicTechnology", "BasicScience", "CCA", "CivicEducation", "Mathematics", "English", "PHE"];
  const seniorSubs = ["DigitalTech", "Computer", "English", "Mathematics", "Biology", "Chemistry", "Physics",
